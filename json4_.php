...
<div id="container">
<div id="title">
<a href="json4.php"><img src="img/pilogo.png" width="379" height="69"></a>
...
foreach ( $JSONDATA as $name => $rowdata )
{
	echo "<tr>\n";
	echo '<td class="name">' . $rowdata->NAME . '</td>' . "\n";
	foreach ($fields as $field) {
		echo '<td class="data">' . number_format($rowdata->DATA->$field, 2) . '</td>' . "\n";
	}
	echo "</tr>\n";
}
echo "</table>\n";
